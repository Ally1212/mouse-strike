...
- **六机差异**：六架战机拥有独立属性、轮廓、主色、专属副武器和战术技能。
- **高火力开局**：不从弱小状态起步，默认使用 LV.3 五向主炮并获得短时火力增幅。
- **战场构筑**：击毁 Boss 后从伤害、射速/能量、护盾三类模块中选择强化。
...
| 国家代码 | 战机 | 定位 | 战术能力 |
| --- | --- | --- | --- |
| USA | F-22 Raptor | 隐身突击 | 幽灵追踪导弹群 |
| GBR | Eurofighter Typhoon | 高速截击 | 多轨道风暴长矛 |
| FRA | Dassault Rafale | 全域攻击 | 双相波动炮阵 |
| SWE | JAS 39 Gripen | 轻型游击 | 北境高速轨道齐射 |
| RUS | Sukhoi Su-57 | 重型破阵 | 新星高伤爆破弹 |
| CHN | Chengdu J-20 | 远程压制 | 威龙追踪蜂群 |
